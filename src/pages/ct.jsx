        ...
        <div className="bg-white px-4 sm:px-6 py-10 max-w-7xl mx-auto border-b border-b-gray-500">
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:w-1/2 ">
              ...
              <p>1. We're here to assist you with all your queries and project needs.</p>
              <p>2. Expect a prompt response — typically within 24 working hours.</p>
              <p>3. Reach us anytime via call, email, or the contact form.</p>
              <p>4. Every message is important to us, and handled with care.</p>
              <p>5. Let's build something great together</p>
</div>
<br>
              ...
              <div className="space-y-6">
                <div className="flex flex-col lg:flex-row gap-6">
                  <div className="bg-white rounded p-6 border hover:scale-105 transition flex-1">
                ...
                <div className="bg-white rounded p-6 border hover:scale-105 transition">
...
<div className="lg:w-1/2 bg-blue-600
    py-[7px] px-[22px]
   text-white rounded">
  <h2 className="text-[1.5rem] font-bold text-white border-b-2 border-white inline-block pb-1">
    Contact Us
  </h2>
  ...
  <form onSubmit={onSubmit} className="space-y-6 animate-fadeIn mt-6">
    <div className="flex flex-wrap md:flex-nowrap gap-6">
      <div className="w-full md:w-1/2">
        ...
        <input
          className="w-full border border-gray-300 rounded py-3 px-4 outline-blue-600 transition  text-black"
          type="text"
          name="Name"
    ...
    <div>
      ...
      <textarea
        className=" text-black w-full border border-gray-300 rounded py-3 px-4 h-48 resize-none outline-blue-600 transition"
        name="Message"
    ...
    <button
      type="submit"
      className="bg-black text-white font-semibold py-2 px-8 rounded shadow transition duration-300"
    >
