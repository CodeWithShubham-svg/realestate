...
<br>
              ...
              <div className="space-y-6">
                <div className="flex flex-col lg:flex-row gap-6">
                  <div className="bg-white p-6 border hover:scale-105 transition flex-1">
                ...
                <div className="bg-white p-6 border hover:scale-105 transition">
...
<div className="lg:w-1/2 bg-blue-600
    py-[7px] px-[22px]
   text-white">
  <h2 className="text-[1.5rem] font-bold text-white border-b-2 border-white inline-block pb-1 pt-3.5">
      Get in touch
  </h2>
