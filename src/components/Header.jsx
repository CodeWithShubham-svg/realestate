    ...
    return (
        <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' style={{ backgroundImage: "url('/header_img.png')" }} id='Header'>
            ...
            <motion.div
                ...
                <h2 className='text-5xl sm:text-5xl md:text-[82px] inline-block max-w-3xl font-semibold pt-20 text-[40px]'>Designing Spaces, Building Your Future</h2>
                <div className='space-x-6 mt-16'>
                    <a href='#Amenities' className='border border-white px-8 py-3 rounded'>Amenities</a>
                    <a href='#Contact' className='bg-blue-500 px-8 py-3 rounded'>Contact Us</a>
                </div>

                <a href="tel:+918238812121" className='text-2xl sm:text-3xl md:text-[25px] inline-block max-w-3xl font-bold pt-10'><span className='underline underline-offset-4 decoration-1 under font-light'>Call us at</span>
                : 8238812121</a>

                <a 
  href="tel:+918238812121" 
  className="bg-blue-500 rounded-full fixed right-5 bottom-5 md:hidden py-2.5 px-2.5 z-[1000] text-white shadow-lg"
>
