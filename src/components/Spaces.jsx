...
const Spaces = () => {
  ...
  alt={project.title}
  effect="none"
  className='w-full h-auto mb-14 transition hover:scale-105'
/> */}

              <LazyLoadImage src={plan.image} alt={plan.title} effect="none" className="w-full h-auto mb-14 transition hover:scale-105" />
