...
const About = () => {
    ...
    <div className='grid grid-cols-2 gap-6 md:gap-10 w-full 2xl:pr-28'>
      ...
      <div className='mt-5'>
   <p className='mb-2 text-[15px] md:font-3xl text-black text-start underline'><b>RERA NO:</b> <span>GUJ/2435/PROJECT/8892</span></p>
   <p className='mb-2 text-[15px] md:font-3xl text-black text-start'><b>GSTIN :</b> <span>GUJ1234</span></p>
